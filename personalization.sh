...
function requirements(){
    ...
    # Clone the personalization repository.
    sudo git clone https://github.com/ricardev2023/personalization.git /usr/share/personalization

    # Requirements Installation.
    cat /usr/share/personalization/requirements.txt | sudo xargs apt install
